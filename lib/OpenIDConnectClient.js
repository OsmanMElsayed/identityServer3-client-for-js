...
AuthenticationContext.prototype.login = function () {
    ...
    var scope = 'openid ' + scope;
    var urlNavigate = this._getNavigateUrl('id_token token', this.config.scope) + '&nonce=' + encodeURIComponent(this._idTokenNonce);
...
AuthenticationContext.prototype.getCachedToken = function (tokenType) {
    ...
    if (tokenType == this.CONSTANTS.ACCESS_TOKEN) {
        ...
        tokenTypeKey = this.CONSTANTS.STORAGE.ACCESS_TOKEN_EXPIRATION_KEY;
    }
    else if (tokenType == this.CONSTANTS.ID_TOKEN) {
        tokenTypeKey = this.CONSTANTS.STORAGE.ID_TOKEN_KEY;
        tokenTypeKey = this.CONSTANTS.STORAGE.ID_TOKEN_EXPIRATION_KEY;
    }
    else {
        return null;
    }
...
AuthenticationContext.prototype.acquireToken = function (tokenType, callback) {
    ...
    if (token) {
        this._logstatus('Tsoken in cache');
        callback(null, token);
        return;
    }
...
AuthenticationContext.prototype._getNavigateUrl = function (responseType, scope) {
    ...
    var urlNavigate = this.authorizationEndpoint + '?' + this._serialize(responseType, this.config, scope);
